  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: validPartNumber || product.name,
        item: productUrl,
      },
    ],
  };
      ...
      <section className="border-b border-navy-600 bg-gradient-to-r from-navy-800 to-navy-700">
        <div className="page-container py-12">
          ...
          <p className="max-w-3xl text-slate-300">
            Industrial automation spare part available for RFQ, worldwide
            shipping and fast quotation support.
          </p>
        </div>
      </section>
        ...
        <div className="mb-14 grid gap-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            <div className="mb-5 grid grid-cols-12 gap-3">
              ...
              <div
                className={`rounded-lg border border-navy-700 bg-navy-800 p-3 ${
                  validPartNumber ? "col-span-2" : "col-span-6"
                }`}
              >
                <p className="mb-1 text-xs text-slate-500">Condition</p>
              ...
              <div
                className={`rounded-lg border border-navy-700 bg-navy-800 p-3 ${
                  validPartNumber ? "col-span-3" : "col-span-6"
                }`}
              >
                <p className="mb-1 text-xs text-slate-500">Availability</p>
            ...
            <div className="mb-8 rounded-xl border border-navy-700 bg-navy-800 overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="flex justify-between border-b border-navy-700 px-5 py-3">
                  ...
                  <span className="text-white">DHL / FedEx Worldwide</span>
                </div>
              </div>
            </div>
            <div className="mb-6">
                ...
                {seo.description
                  ...
                  .map((paragraph, index) => (
                    <p
                      ...
                      className={
                        index === 0 ? "font-medium text-slate-200" : ""
                      }
                    >
                      {paragraph}
                    </p>
            ...
            <div className="mb-6 grid grid-cols-2 gap-3">
              {[
                ...
                >
                  <p className="text-xs font-semibold text-gold-500">{text}</p>
                </div>
              ))}
            </div>
